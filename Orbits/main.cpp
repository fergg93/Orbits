...
void PhysicsLoop( void )
{
  ...
  RenderString( 1, 2, "Left click to spawn a particule" );
  RenderString( 1, 4, "Right click to spawn a moving particle" );
...
//  b->SetStatic( );
  ...
  PolygonShape poly;
  poly.SetBox( 33.0f, 1.0f );
  Body *b = scene.Add( &poly, 40, 58 );
  b->SetStatic( );
  b->SetOrient( 0 );

  PolygonShape poly1;
  poly1.SetBox( 30.0f, 1.0f );
  b = scene.Add( &poly1, 5, 30 );
  b->SetStatic( );
  b->SetOrient(1.575);

  PolygonShape poly2;
  poly2.SetBox( 33.0f, 1.0f );
  b = scene.Add( &poly2, 40, 2 );
  b->SetStatic( );
  b->SetOrient( 0 );

  PolygonShape poly3;
  poly3.SetBox( 30.0f, 1.0f );
  b = scene.Add( &poly3, 75, 30 );
  b->SetStatic( );
  b->SetOrient( 1.575 );
